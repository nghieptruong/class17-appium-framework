...
public class ExtentReportManager {
    ...
    private static final String REPORT_PATH = "extentreport-output/ExtentReport_" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_hh_mm_ss")) + ".html";
    private static final String SCREENSHOT_PATH = "extentreport-output/screenshots/";
